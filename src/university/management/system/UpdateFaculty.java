...
public class UpdateFaculty extends JFrame implements ActionListener{
    ...
    public UpdateFaculty(){
        ...
        search=new JLabel("Search By Employee no");
        ...
        String qry="select * from faculty_info";
        try{
            Conn c11=new Conn();
        ...
        roll=new JLabel("Employee Number");
...
//        System.out.println(rollno);
        try{
            ...
            String qry1="select * from faculty_info where eno=?";
...
//        setVisible(true);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==exit){
            ...
            String qry="update faculty_info set address=? , phone=? , email=? , qual=? , department=? where eno=?";
            try{
                Conn c1=new Conn();
                ...
                if(a==1){
                    JOptionPane.showMessageDialog(null, "Faculty Record Updated");
                    setVisible(false);
                }
                else
                    JOptionPane.showMessageDialog(null, "Faculty record not updated");
            }catch(Exception e){
                System.out.println(e);
            }
        }
