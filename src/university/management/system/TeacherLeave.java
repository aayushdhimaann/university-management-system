...
public class TeacherLeave extends JFrame implements ActionListener{
    ...
    TeacherLeave(){
        ...
        JLabel emp=new JLabel("Search By Employee Id");
        emp.setBounds(20, 60, 200, 30);
        emp.setFont(new Font("tahoma",Font.PLAIN,18));
        add(emp);
