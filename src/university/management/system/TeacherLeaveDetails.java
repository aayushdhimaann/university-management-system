...
//        getContentPane().setBackground(Color.white);
        ...
        JLabel student=new JLabel("Teacher Leave Details");
        student.setBounds(380, 20, 250, 30);
        ...
        add(c1);
        String qry="select * from faculty_leave";
        try{
            Conn c11=new Conn();
        ...
        cancel.setBounds(260, 80, 100, 20);
...
//    public voi
    public void actionPerformed(ActionEvent e){
        if(e.getSource()==search){
            ...
            String qry="select * from faculty_leave where roll =?";
            try{
                Conn c12=new Conn();
